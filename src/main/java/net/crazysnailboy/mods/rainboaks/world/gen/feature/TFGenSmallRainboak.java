package net.crazysnailboy.mods.rainboaks.world.gen.feature;
...
public class TFGenSmallRainboak extends WorldGenAbstractTree
{
    private static final IBlockState DEFAULT_TRUNK = ModBlocks.LOG.getDefaultState();
    private static final IBlockState DEFAULT_LEAF = ModBlocks.LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    ...
    public TFGenSmallRainboak(boolean p_i2027_1_)
    {
        this(p_i2027_1_, 4, DEFAULT_TRUNK, DEFAULT_LEAF, false);
    }

    public TFGenSmallRainboak(boolean p_i46446_1_, int p_i46446_2_, IBlockState p_i46446_3_, IBlockState p_i46446_4_, boolean p_i46446_5_)
    {
        super(p_i46446_1_);
