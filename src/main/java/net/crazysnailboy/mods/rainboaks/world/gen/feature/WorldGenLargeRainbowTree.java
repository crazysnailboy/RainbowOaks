...
public class WorldGenLargeRainbowTree extends WorldGenAbstractTree
{
	...
	void generateLeafNode(BlockPos pos)
	{
		...
		{
			this.crosSection(pos.up(i), this.leafSize(i), ModBlocks.LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false)));
		}
	}
